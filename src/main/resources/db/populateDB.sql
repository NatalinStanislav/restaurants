...
VALUES ('Mexican pizza', 999, '2020-01-30', 100006),
       ...
       ('Today Mexican pizza', 999, NOW(), 100006),
       ('Today Italian salad', 349, NOW(), 100006),
       ('Today Cappuccino', 199, NOW(), 100006),
       ('Today Philadelphia roll', 849, NOW(), 100007),
       ('Today Fish salad', 249, NOW(), 100007),
       ('Today Green tea', 99, NOW(), 100007),
       ('Today Kebab XXL', 1249, NOW(), 100008),
       ('Today Garlic sauce', 99, NOW(), 100008),
       ('Today Beer', 399, NOW(), 100008);
