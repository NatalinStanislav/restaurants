...
public class AdminDishRestController {
    ...
    public List<Dish> getAllFromRestaurantByDate(@RequestParam int restaurantId, @RequestParam LocalDate date) {
    ...
    @GetMapping("/byDate")
    public List<Dish> getAllByDate(@RequestParam LocalDate date) {
